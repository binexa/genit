 ...
 * @access    public
 */
class DOGeneratorGenitPicker extends DOGeneratorAbstract
{
	/**
	...
	function __construct( $metaGen )
	{
		...
		$this->do_short_name_default = $componentName . "PickerDO";
		$this->do_short_name_default_sort = $componentName . "PickerSortDO";
