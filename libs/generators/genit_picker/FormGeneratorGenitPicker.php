 ...
 * @access    public
 */
class FormGeneratorGenitPicker extends FormGeneratorAbstract
{
    ...
    protected function _setObjectNames()
    {
        ...
        $this->list_form = $componentName . 'PickerListForm';
        $this->detail_form = $componentName . 'PickerDetailForm';        
