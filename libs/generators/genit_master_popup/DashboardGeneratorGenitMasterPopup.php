...
include_once dirname(__FILE__).'/../genit_master/DashboardGeneratorGenitMaster.php';
 ...
 * @access    public
 */
class DashboardGeneratorGenitMasterPopup extends DashboardGeneratorGenitMaster
{
}
