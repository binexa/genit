...
include_once dirname(__FILE__).'/../genit_master/DOGeneratorGenitMaster.php';
 ...
 * @access    public
 */
//class DOGeneratorGenitDetail extends DOGeneratorGenitMaster
//{
//}

class DOGeneratorGenitDetail extends DOGeneratorAbstract
{
	/**
